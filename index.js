...
if (atmAnswer.myPin === answerPin) {
    ...
    if (operationAns.operation === "Withdraw") {
        ...
        if (amountAns.amount <= 10000) {
            ...
            console.log(`Requested amount is high than your account balance Rs. ${mybalance}`);
    }
    ...
    console.log("Dear customer your pin code is wrong! please provide correct pin code.");
}
